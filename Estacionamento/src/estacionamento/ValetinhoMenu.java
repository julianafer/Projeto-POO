	...
	private void initialize() {
		...
		btnentrada.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ValetinhoEntrada telaent = new ValetinhoEntrada(estacionamento);
			}
		});
		...
		btnsaida.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ValetinhoSaida telasai = new ValetinhoSaida(estacionamento);
			}
		});
		...
		btnconsulta.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ValetinhoConsulta telacon = new ValetinhoConsulta(estacionamento);
			}
		});
		...
		btntransf.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ValetinhoTransferencia telatra = new ValetinhoTransferencia(estacionamento);
			}
		});
		btntransf.setBackground(new Color(255, 255, 153));
		btntransf.setBounds(126, 249, 183, 23);
		frame.getContentPane().add(btntransf);

		JButton btngeral = new JButton("Lista Geral");
		btngeral.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ValetinhoGeral telager = new ValetinhoGeral(estacionamento);
			}
		});
		...
		JButton btnlivres = new JButton("Lista de Vagas Livres");
		btnlivres.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ValetinhoLivres telaliv = new ValetinhoLivres(estacionamento);
			}
		});
		...
		JMenuItem menugeral = new JMenuItem("Lista geral");
		...
		JMenuItem menulivres = new JMenuItem("Lista de vagas livres");
